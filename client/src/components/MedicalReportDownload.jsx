...
const MedicalReportDownload = ({
  ...
  const isCriticalReport = report?.riskScore >= 80;
  const buttonTheme = isCriticalReport
    ? "text-red-200 border border-red-500/20 bg-red-500/10 hover:bg-red-500/20"
    : "text-blue-300 border border-blue-500/20 bg-blue-500/10 hover:bg-blue-500/20";
  ...
  return (
    ...
    <div className="relative inline-block">
      ...
      <button
        ...
        className={`text-xs px-3 py-1.5 rounded transition disabled:opacity-50 disabled:cursor-not-allowed ${buttonTheme}`}
